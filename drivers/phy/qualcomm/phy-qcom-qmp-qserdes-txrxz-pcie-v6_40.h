 ...
 *
 * Nord PCIe Gen5 16-lane PHY — TXRXZ combined TX/RX zone block registers.
 * Offsets are relative to the TXRXZ sub-region base (segment_base + 0xd000).
 * Source: NORDSCHLEIFE_2.0 QMP PCIe v6.40 16lane PHY HSR for n4_30.0
 */
