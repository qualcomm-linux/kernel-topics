...
extern phys_addr_t arm_smmu_iova_to_phys_hard(struct iommu_domain *domain,
		                                              dma_addr_t iova);
extern phys_addr_t qcom_smmu_itop_hard(struct iommu_domain *dom, dma_addr_t iova);
				    ...
				    struct qcom_iommu_atos_txn *txn)
{
	...
	return qcom_smmu_itop_hard(domain, txn->addr);	
}
